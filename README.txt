...
The Smithsonian Appliance module provides an interface to obtain search results from a dedicated Smithsonian Search Appliance (GSA) hardware device. The module can act as a replacemet for core Search, or it may operate in tandem with it.
